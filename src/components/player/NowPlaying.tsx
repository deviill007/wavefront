...
export default function NowPlaying() {
  ...
  useEffect(() => {
    ...
    fetchRelated(currentTrack.id, currentTrack.title, currentTrack.artist).then(
      (tracks) => {
        setRelated(tracks);
    ...
    >
      ...
      {!currentTrack ? (
        ...
        >
          ...
          >
            Pick a track and it'll appear here
          </p>
        </div>
      ) : (
        <div
        ...
        >
                ...
                <button
                  ...
                  style={{
                    ...
                    color: videoMode
                      ...
                      : "rgba(255,255,255,0.30)",
                    boxShadow: videoMode
                      ? `inset 0 1px 0 rgba(255,255,255,0.07), 0 0 0 1px rgba(${accentRgb}, 0.28)`
                      : "none",
                  }}
                >
                  <Tv2 size={11} />
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        inset: 0,
                        background:
                          "linear-gradient(135deg, rgba(255,255,255,0.07) 0%, transparent 45%, rgba(0,0,0,0.15) 100%)",
                        pointerEvents: "none",
                      }}
                    />
                    <div
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  color: liked ? `rgb(${accentRgb})` : "rgba(255,255,255,0.28)",
                }}
              >
                <Heart
                  size={13}
                  style={{
                    fill: liked ? `rgb(${accentRgb})` : "none",
            ...
            >
              ...
              {videoMode && (
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 11, color: `rgba(${accentRgb}, 0.9)` }}
                  >
                    Video mode
                  </span>
                </div>
              ...
              {(["info", "queue"] as const).map((t) => (
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      tab === t
                        ? `0 1px 4px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.06), 0 0 0 1px rgba(${accentRgb}, 0.14)`
                        : "none",
                  }}
                >
                  <Music2 size={11} />
          ...
          {/* Tab content */}
          <div
            style={{ flex: 1, padding: "12px 20px 80px", overflowY: "auto" }}
          >
            {tab === "queue" ? (
              <>
                <p
              ...
              <>
                ...
                {loadingRelated ? (
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderTopColor: `rgba(${accentRgb}, 0.8)`,
                  ...
                  <p style={{ fontSize: 12, color: "rgba(255,255,255,0.17)" }}>
